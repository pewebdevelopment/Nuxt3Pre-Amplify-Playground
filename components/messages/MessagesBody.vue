      ...
      <div class="flex items-start mb-4 last:mb-0">
        ...
        <div>
          ...
          <div class="flex items-center justify-between">
            <div class="text-xs text-slate-500 font-medium">2:40 PM</div>
            <svg
              class="w-5 h-3 shrink-0 fill-current text-emerald-500"
              viewBox="0 0 20 12"
            >
              <path
        ...
        <div>
          <div class="flex items-center">
            ...
            >
              ...
              <svg
                class="w-4 h-4 shrink-0 fill-current text-slate-400"
                viewBox="0 0 16 16"
              >
                <path
      ...
      <div class="flex items-start mb-4 last:mb-0">
        ...
        <div>
          ...
          >
            ...
            et leo duis. Viverra justo nec ultrices dui.<br />
      ...
      <div class="flex items-start mb-4 last:mb-0">
        ...
        <div>
          <div
            class="text-sm bg-indigo-500 text-white p-3 rounded-lg rounded-tl-none border border-transparent shadow-md mb-1"
          >
            Can you join <a class="font-medium" href="#0">@dominik</a>?
            <a class="underline" href="#0"
              >https://meet.google.com/haz-r3gt-idj</a
            >
          </div>
          <div class="flex items-center justify-between">
