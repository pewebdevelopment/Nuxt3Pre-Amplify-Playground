<template>
  <div class="sticky bottom-0">
    <div
      class="flex items-center justify-between bg-white border-t border-slate-200 dark:bg-slate-800 px-4 sm:px-6 md:px-5 h-16"
    >
      <!-- Plus button -->
      ...
      <!-- Message input -->
      <form class="grow flex items-center justify-between">
        <div class="flex grow mr-3 justify-between">
          <label for="message-input" class="sr-only">Type a message</label>
          <input
            id="message-input"
            class="form-input relative w-full h-full rounded-md bg-slate-100 border-transparent focus:bg-white focus:border-slate-300 dark:bg-slate-300 focus:dark:bg-slate-400"
            type="text"
        ...
        <!-- <button
          type="submit"
          class="btn p-1 bg-indigo-500 hover:bg-indigo-600 text-white whitespace-nowrap rounded-md dark:bg-gray-900"
        >
          Send -&gt;
        </button> -->
