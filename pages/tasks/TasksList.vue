          ...
          <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div class="max-w-3xl mx-auto">
              ...
              <div class="space-y-6">
                <!-- Group 1 -->
                <div>
                  <h2 class="grow font-semibold text-slate-800 truncate mb-4">
                    To Do's 🖋️
                  </h2>
                  <div class="space-y-2">
                    <!-- Task -->
                    ...
                    >
                      <div class="sm:flex sm:justify-between sm:items-start">
                          ...
                          <div class="flex items-center">
                            ...
                            <label class="flex items-center">
                              ...
                              <span
                                ...
                                >Senior Software Engineer Backend</span
                              >
                            </label>
                          </div>
                        </div>
                        ...
                        <div class="flex items-center justify-end space-x-3">
                          ...
                          <!-- Like button -->
                          <button
                            class="flex items-center text-slate-400 hover:text-indigo-500"
                          >
                            <svg
                        ...
                        <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                          <div class="flex items-center">
                            ...
                            <label class="flex items-center">
                              ...
                              <span
                                class="font-medium text-slate-800 peer-checked:line-through ml-2"
                                >User should receive a daily digest email</span
                              >
                            </label>
                          </div>
                        </div>
                        ...
                        <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                          <div class="flex items-center">
                            ...
                            <label class="flex items-center">
                              ...
                              <span
                                class="font-medium text-slate-800 peer-checked:line-through ml-2"
                                >Change license and remove products</span
                              >
                            </label>
                          </div>
                        </div>
                          ...
                          <ul class="pl-12 space-y-3">
                            <li>
                              <label class="flex items-center">
                                ...
                                />
                                <span
                                  class="text-sm text-slate-800 peer-checked:line-through ml-3"
                                  >Finish the presentation</span
                                >
                              </label>
                            </li>
                            <li>
                ...
                <div>
                  ...
                  <div class="space-y-2">
                    <!-- Task -->
                    <div
                      class="bg-white shadow-lg rounded-sm border border-slate-200 p-4 opacity-60"
                      draggable="true"
                    >
                      <div class="sm:flex sm:justify-between sm:items-start">
                        <!-- Left side -->
